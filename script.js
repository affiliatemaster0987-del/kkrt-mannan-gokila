/* ═══════════ CONFIG ═══════════ */
const CONFIG = {
  API_BASE: "/api",   // same-domain backend (server.js)
...
function jackpotTextOld(){
  return `🚀 KRT AI JACKPOT\n\nStock : SBIN\nAI Score : 97/100\nProbability : 94%\n\n🟢 BUY\nEntry: 1085\nSL: 1072\nT1: 1096 | T2: 1107 | T3: 1120\n\nReasons: Positive News ✅ PWH Break ✅ Delivery 72% ✅ RVol 3.4x ✅ RSI 68 ✅ Put Writing ✅\n\n⚠ Educational only. Not investment advice.`;
}
...
/* ═══════════ LIVE API BRIDGE ═══════════
   Backend ready aana CONFIG.API_BASE set pannunga.
   /gainers, /losers, /breaks/pd, /breaks/pw, /breaks/pm, /scan
   endpoints-la Chartink webhook data serve pannina auto-render agum. */
